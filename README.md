# intersect.ts [![Node.js Package](https://github.com/lirannl/Intersect.ts/actions/workflows/npm-publish.yml/badge.svg)](https://github.com/lirannl/Intersect.ts/actions/workflows/npm-publish.yml)
